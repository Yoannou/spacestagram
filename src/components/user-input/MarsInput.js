    ...
    <div className="mars-input-container">
      <form className="mars-input-form">
        <div className="rover-select">
          <input type="button" className="btn" name="spirit" value="Spirit" onClick={handleRoverChange}></input>
          <input type="button" className="btn" name="opportunity" value="Opportunity" onClick={handleRoverChange}></input>
          <input type="button" className="btn" name="curiosity" value="Curiosity" onClick={handleRoverChange}></input>
        </div>
